                    ...
                    children: <Widget>[
                      ...
                      const SizedBox(width: 10 ,),
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text(lista[index].nome.toString(),style:  TextStyle(color: black54,fontFamily: 'PlayfairDisplay',fontSize: 14,fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis, maxLines: 1,),
                            const SizedBox(height: 2,),
                            Text("${lista[index].zona}",style:  TextStyle(color: black54,fontFamily: 'PlayfairDisplay',fontSize: 12,fontWeight: FontWeight.w500), overflow: TextOverflow.ellipsis, maxLines: 1,),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(onTap: () {
                                  Get.to(() => ArFossil(model: lista[index], source: "Fossili",));
                                },
                                  child: Container(padding: const EdgeInsets.all(5),
                                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(16), color: white,),
                                    child:  Column(
